document.addEventListener('DOMContentLoaded', function () {
    ...
    const lcaNeedSelect = document.getElementById('lca_need');
    ...
    const budgetRangeSelect = document.getElementById('budget_range');
    ...
    if (lcaNeedSelect) {
        lcaNeedSelect.addEventListener('change', function () {
            toggleError('error-lca_need', false);
        });
    }
    ...
    leadForm.addEventListener('submit', function (event) {
        ...
        formData.append('product_type', productTypeInput ? productTypeInput.value : 'LCA');
        formData.append('lca_need', lcaNeedSelect ? lcaNeedSelect.value : '');
        ...
        formData.append('budget_range', budgetRangeSelect ? budgetRangeSelect.value : '');
        ...
        formData.append('form_source', 'lca_form');
